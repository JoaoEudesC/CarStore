import { SpecificationRepositoryInMemory } from "../../../../modules/cars/repositories/in-memory/SpecificationRepositoryInMemmory";
...
describe("Create Car Specification" , () =>{
    ...
    it("should be able to add a new specification to the car", async () =>{
        ...
        const specifications_id = [specification.id].filter(Boolean) as string[]; // adiciona um filtro para remover valores indefinidos e converte para string[], para fazer uma verificação, caso o contrárioo typescript diz que pode ser colocado uma propriedade undefined ai, mas eu colocquei como string, então eu tenho que previnir essa possibilidade.
